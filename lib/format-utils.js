...
exports.chooseFormat = (formats, options) => {
  ...
  switch (quality) {
    default:
    case 'best': {
      formats = exports.filterFormats(formats, 'videoandaudio');
      ...
      const bestAudioQuality = formats.map(f => f.audioBitrate || 0).sort((a, b) => b - a)[0];
      format = formats.find(f => (f.audioBitrate || 0) === bestAudioQuality);
      break;
    }
